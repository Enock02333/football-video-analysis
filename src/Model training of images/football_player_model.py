...
if __name__ == '__main__':
    # Path to the dataset
    dataset_path = "C:/Users/enock/Downloads/dataset/football-players-detection"

    # Path to data.yaml
    data_yaml = os.path.join(dataset_path, "data.yaml")

    # Initialize and train the YOLO model
    model = YOLO("yolov8m.pt")  # Use YOLOv8n pre-trained weights
    ...
    model.train(
        ...
        name="football_detection",  # Name of the run
        device='cuda',
        half=True
    )
